...
def login(driver):
    ...
    login_url = 'https://account.co.sportsbook.fanduel.com/login?external-referrer-next='
    driver.get(login_url)

    time.sleep(3)
    driver.find_elements(By.CSS_SELECTOR, "input")[0].send_keys(email)
    driver.find_elements(By.CSS_SELECTOR, "input")[1].send_keys(password)
    driver.find_element(By.CSS_SELECTOR, "button").click()
    # driver.find_elements(By.CSS_SELECTOR, "input[label='Email address']")[0].send_keys(email)
    # driver.find_elements(By.CSS_SELECTOR, "input[data-test-id='field-password']")[0].send_keys(password)
