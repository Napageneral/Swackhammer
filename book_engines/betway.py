...
def login(driver):
    ...
    login_url = 'https://co.betway.com/'
    driver.get(login_url)

    time.sleep(2)
    driver.find_elements(By.XPATH, "//span[contains(text(), 'Login')]")[0].click()
    time.sleep(1)
    ...
    driver.find_elements(By.XPATH, "//span[contains(text(), 'Login')]")[1].click()
    time.sleep(1)
