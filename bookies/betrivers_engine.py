...
def login(driver):
    ...
    login_url = 'https://co.betrivers.com/?page=sportsbook&feed=featured#home'
    driver.get(login_url)

    time.sleep(1)
    driver.find_elements(By.XPATH, "//button[contains(text(), 'Login')]")[0].click()
    time.sleep(1)
    driver.find_elements(By.CSS_SELECTOR, "input#login-form-modal-email")[0].send_keys(email)
    driver.find_elements(By.CSS_SELECTOR, "input#login-form-modal-password")[0].send_keys(password)
    driver.find_element(By.CSS_SELECTOR, "button#login-form-modal-submit").click()
    time.sleep(1)

def get_mma_bet_buttons(driver):
    mma_url = "https://co.betrivers.com/?page=sportsbook&group=1000093883&type=matches"
    ...
    try:
        while True:
            show_more_button = driver.find_elements(By.XPATH, "//button[contains(text(), 'Show more')]")[0]
    ...
    matches = driver.find_elements(By.CSS_SELECTOR, "div.sc-LoTwT.itlLZb")
